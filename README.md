...
<img src="docs/images/wordcloud.png" alt="word cloud of ilibgo's own feature names" width="700">

*A word cloud built from ilibgo's own feature list — anti-aliased TrueType text,
random-palette coloring, 90° rotation, and glyph-mask packing — drawn with the
library itself. Generated by the [`wordcloud`](wordcloud) tool from
[`ilibgo-features.json`](wordcloud/ilibgo-features.json).*
...
| [`wordcloud`](wordcloud) | Render a word cloud from a JSON config or `count word` frequencies |

...
func Font_helvBO14() []string {
  return font_helvBO14
}

var font_helvBO14 []string = []string{
  "STARTFONT 2.1",
  "FONT -Adobe-Helvetica-Bold-O-Normal--20-140-100-100-P-103-ISO10646-1",
  "SIZE 14 100 100",
  "FONTBOUNDINGBOX 24 29 -3 -7",

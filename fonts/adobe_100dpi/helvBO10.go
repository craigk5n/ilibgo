...
func Font_helvBO10() []string {
  return font_helvBO10
}

var font_helvBO10 []string = []string{
  "STARTFONT 2.1",
  "FONT -Adobe-Helvetica-Bold-O-Normal--14-100-100-100-P-82-ISO10646-1",
  "SIZE 10 100 100",
  "FONTBOUNDINGBOX 19 23 -1 -6",

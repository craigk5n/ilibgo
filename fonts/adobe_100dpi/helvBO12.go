...
func Font_helvBO12() []string {
  return font_helvBO12
}

var font_helvBO12 []string = []string{
  "STARTFONT 2.1",
  "FONT -Adobe-Helvetica-Bold-O-Normal--17-120-100-100-P-92-ISO10646-1",
  "SIZE 12 100 100",
  "FONTBOUNDINGBOX 23 27 -4 -7",

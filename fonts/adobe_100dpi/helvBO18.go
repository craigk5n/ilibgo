...
func Font_helvBO18() []string {
  return font_helvBO18
}

var font_helvBO18 []string = []string{
  "STARTFONT 2.1",
  "FONT -Adobe-Helvetica-Bold-O-Normal--25-180-100-100-P-138-ISO10646-1",
  "SIZE 18 100 100",
  "FONTBOUNDINGBOX 29 37 -1 -8",

...
func Font_helvBO24() []string {
  return font_helvBO24
}

var font_helvBO24 []string = []string{
  "STARTFONT 2.1",
  "FONT -Adobe-Helvetica-Bold-O-Normal--34-240-100-100-P-182-ISO10646-1",
  "SIZE 24 100 100",
  "FONTBOUNDINGBOX 43 49 -5 -12",

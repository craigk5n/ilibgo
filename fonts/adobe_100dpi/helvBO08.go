...
func Font_helvBO08() []string {
  return font_helvBO08
}

var font_helvBO08 []string = []string{
  "STARTFONT 2.1",
  "FONT -Adobe-Helvetica-Bold-O-Normal--11-80-100-100-P-60-ISO10646-1",
  "SIZE 8 100 100",
  "FONTBOUNDINGBOX 13 19 -2 -5",
